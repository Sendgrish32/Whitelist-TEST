...
работает на Python и понадобится лишь библиотека 
requests. Ее можно скачать этой командой:
...
works in Python and you only need a library 
requests. You can download it with this command:
